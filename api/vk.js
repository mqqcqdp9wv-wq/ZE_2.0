...
const AUTO_REPLY = `Здравствуйте! Получили ваше сообщение, связываемся с мастером.

Пока ждёте — коротко о том, с чем мы работаем:
Не снимаем обшивку дверей — заводская сборка остаётся нетронутой.
Работаем только с американской плёнкой Rayno. Два варианта:
1. Карбоновая тёмная — не выгорает, глубокий чёрный, затемнение от 5% до 50%.
2. Керамическая атермальная — защита от нагрева и УФ для передней полусферы.

🏆 В 2026 году студия в очередной раз получила награду Яндекса «Хорошее место». Отзывы клиентов: https://yandex.com/maps/org/studiya_tonirovaniya_yeleny_zakharovoy/20822113531/

Срочный вопрос? Звоните напрямую мастеру: +7 (915) 858-21-15 (Елена)`;
